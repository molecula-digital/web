...
const skills = [
  {
    icon: MessageSquare,
    title: "Chatbots",
    description: "Atiende clientes 24/7 y reduce hasta 60% las consultas repetitivas",
  ...
  },
  {
    ...
    description: "Nunca pierdas un lead: seguimiento automático y alertas inteligentes",
    className: "md:col-span-1 md:row-span-1",
  },
  {
    icon: Wallet,
  ...
  },
  {
    icon: GitBranch,
    title: "Workflows",
    description: "Conecta tus herramientas favoritas en un solo flujo automatizado",
    className: "md:col-span-2 md:row-span-1",
  },
];
